...
compcorr.c -- A program for calculating values of several different
correlation function estimators separately for both transverse and parallel
components as seen from origin using given data and random samples.
